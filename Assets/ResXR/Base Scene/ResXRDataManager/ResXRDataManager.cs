...
{
    public string TableName => "ResXR_Logs";
...
public class ResXRDataManager : ResXRSingleton<ResXRDataManager>
{
    // updated from ResXRPlayer
    ...
    // log a new string line with the time logged to ResXR_Logs file.
    ...
    private void Init()
    {
        ...
        exportEyeTracking = ResXRPlayer.Instance.IsEyeTrackingEnabled;
        exportFaceTracking = ResXRPlayer.Instance.IsFaceTrackingEnabled;
