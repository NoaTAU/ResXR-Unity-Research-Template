...
- **Reporter functions**
  Add helper functions in ResXRDataManager_V2 to log your new class.  
...
- OVREyesCollector.cs: eye gazes (angles, valid, confidence, shared time) + focused object & hit point via ResXRPlayer
