...
ResXRPlayer is the main singleton that provides access to all player-related functionality. It initializes and manages hand tracking, eye tracking, face tracking, and input systems.
...
2. **Flow Management Scripts** - Empty base classes for Session/Round/Trial management
   - **You own these scripts** - copy from `Assets/ResXR/Flow Management/` and modify
...
2. **Flow Management**: Copy the base classes from `Assets/ResXR/Flow Management/` and modify them:
   ```csharp
...
Add helper functions in `ResXRDataManager_V2.cs` to log your events:
...
**Important**: The Flow Management scripts in `Assets/ResXR/Flow Management/` are **base templates** that you should **copy and modify** for your experiment. You own these scripts - they're not meant to be used as-is. Copy them into your project folder and customize them for your specific experiment needs.
...
**Location**: `Assets/ResXR/Flow Management/RoundManager.cs`

**Inheritance**: `ResXRSingleton<RoundManager>`
...
**Location**: 
- `Assets/ResXR/Flow Management/Round.cs`
...
1. **Copy Base Classes**: Copy `SessionManager.cs`, `RoundManager.cs`, and `TrialManager.cs` from `Assets/ResXR/Flow Management/` into your project
...
**Location**: `Assets/ResXR/Meta componentrs/`
